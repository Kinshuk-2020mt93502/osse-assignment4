                            ...
                            <div className="card">
                                <div className="card-body">
                                    <div className="d-flex flex-column align-items-center text-center">
                                        <img src={require('../studentImage/'+this.props.image)} alt={this.props.name} className="rounded-circle" width={150} />
                                        <div className="mt-3">
                                            <h4>{this.props.name}</h4>
                                            <p className="text-secondary mb-1">{this.props.designation}</p>
                                            <p className="text-muted font-size-sm">{this.props.location}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <ul className="list-group list-group-flush">
                                    ...
                                    <li className="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                        ...
                                        <span className="text-secondary">
                                            <a href={"https://github.com/" + this.props.github} target="_blank" style={this.buttonStyle}>{this.props.github}</a></span>
                                    </li>
                                    <li className="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                        <h6 className="mb-0"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/></svg> Linkedin</h6>
                                        <span className="text-secondary">
                                            <a href={"https://www.linkedin.com/in/" + this.props.linkedin} style={this.buttonStyle} target="_blank">@{this.props.linkedin}</a></span>
                                    </li>
                                </ul>
                            </div>
                        </div>
                            ...
                            <div className="card mb-3">
                                <div className="card-body">
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-sm-9 text-secondary">
                                            <a className="btn btn-blue" href={this.props.githuburl} target="_blank">
                                                View
                                            </a>
                                        </div>
                                    </div>
